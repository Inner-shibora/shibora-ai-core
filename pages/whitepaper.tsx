        ...
        <section className="max-w-4xl mx-auto space-y-10">
          ...
          <div>
            ...
            <ul className="list-disc list-inside text-gray-300 mt-2">
              ...
              <li>
                AI-Powered News Feed & Insight Curation – Global trends reported in real-time by Echo & Sage,
                aggregating sentiment and signals from top news agencies across the world
              </li>
            </ul>
          </div>
